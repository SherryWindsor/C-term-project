...
static constexpr auto qt_meta_stringdata_ZN9subwindowE = QtMocHelpers::stringData(
    "subwindow",
    "traditionalchess",
    "",
    "skillchess"
...
Q_CONSTINIT static const uint qt_meta_data_ZN9subwindowE[] = {
...
Q_CONSTINIT const QMetaObject subwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9subwindowE.offsetsAndSizes,
    qt_meta_data_ZN9subwindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9subwindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<subwindow, std::true_type>,
        // method 'traditionalchess'
...
void subwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->traditionalchess(); break;
        case 1: _t->skillchess(); break;
        default: ;
        }
    }
    (void)_a;
...
void *subwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9subwindowE.stringdata0))
