...
static constexpr auto qt_meta_stringdata_ZN11StartWindowE = QtMocHelpers::stringData(
    "StartWindow",
    "startPVP",
    "",
    "startPVE"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11StartWindowE[] = {
...
Q_CONSTINIT const QMetaObject StartWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11StartWindowE.offsetsAndSizes,
    qt_meta_data_ZN11StartWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11StartWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *StartWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11StartWindowE.stringdata0))
